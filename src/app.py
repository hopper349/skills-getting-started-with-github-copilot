...
activities = {
    ...
    "Math Club": {
        "description": "Explore advanced mathematics and compete in competitions",
        "schedule": "Tuesdays, 3:30 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["rachel@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots for competition and innovation",
        "schedule": "Wednesdays and Saturdays, 3:00 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["tyler@mergington.edu", "casey@mergington.edu"]
    }
}
